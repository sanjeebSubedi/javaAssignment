package com.soch.sms.controller;
...
import com.soch.sms.service.StudentService;
import com.soch.sms.service.StudentServiceImpl;
...
public class StudentController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			studentDto.setDob((new java.sql.Date(dob.getTime())));
			//studentDto.setDob((java.sql.Date) dob);
